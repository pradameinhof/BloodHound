...
- **_[BHE Only] Completely new Posture page_** - After serving us well for several years, it's time to say goodbye to the old Posture page\\! [The revamped view](/analyze-data/bloodhound-gui/posture-page) is considerably improved over the previous interface in several ways. This includes:
...
- **_[BHE Only] Updated wording on the "Accept" dialog for accuracy._**

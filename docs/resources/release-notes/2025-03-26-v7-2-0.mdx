...
- **_[CE Only] Deep linking Early Access_** -
- **NTLM relay to ADCS added to Early Access** - 
- **New BloodHound documentation portal is live** - 
- **PostgreSQL graph database performance improvements** - 
- **Added support for ACEs on EnterpriseCA objects** - 
- **Updated finding and entity panel texts for NTLM relay paths** - 
